...
. *Lancer l'application dans le gestionnaire de fichiers*
    * Lancer l'exécutable `application_iot-1.0-SNAPSHOT-shaded.jar` en double-cliquant sur celui-ci. Le menu principal de l'application devrait alors apparaître à l'écran.
. *Lancer l'application en ligne de commande*
    ...
    * Lancer ensuite l'exécutable de l'application en exécutant la commande `java -jar application_iot-1.0-SNAPSHOT-shaded.jar`. Le menu principal de l'application devrait alors apparaître à l'écran.
