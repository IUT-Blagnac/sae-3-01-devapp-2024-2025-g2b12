...
Le projet a pour objectif de développer une solution E-commerce pour l’entreprise Woohp resell, PME spécialisée dans la vente de gadgets d’espionnage et de technologies de sécurité. L’entreprise fondée initialement par l'organisation WOOHP (World Organization Of Human Protection) a la volonté d'élargir son marché en se faisant connaître auprès du grand public et ainsi assurer la continuité de son héritage. Cette démarche de digitalisation de l'offre via un site E-commerce s'inscrit dans cette dynamique.


=== *Liens utiles*

Vous trouverez ci-dessous les liens utiles à l'initialisation et la réalisation de ce projet :

|===
| *Intitulés*| *Liens*
|Github Classroom | https:// 
|Cours Moodle SAE 3.01 | https:// 
|Dépôt Template | https:// 
|===
...
.5+| 45 | Web | https://github.com/IUT-Blagnac/sae-3-01-devapp-2024-2025-g2b12/issues[Backlog produit (Product backlog)]
...
| GPO | Contrat d'équipe
.4+| 46 | GPO | Ordre du jour réunion 
...
Cette section regroupe toute la documentation liée à la conception, au développement et à l’utilisation de l’application.
