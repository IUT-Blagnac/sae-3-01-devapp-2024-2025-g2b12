...
|  | 
|  | 
.4+| 50 | GPO| https://github.com/IUT-Blagnac/sae-3-01-devapp-2024-2025-g2b12/blob/master/GPO/CR_R%C3%A9union/Ordre%20du%20Jour%2011.12%20-%20Semaine%2050.pdf[ODJ Reunion 11.12.24]
|  | 
|  | 
|  | 
|===
