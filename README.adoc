...
Le projet a pour objectif de développer une solution E-commerce pour l’entreprise Woohp resell, PME spécialisée dans la vente de gadgets d’espionnage et de technologies de sécurité. 
...
|  | 
|  | 
.4+| 48 |GPO| https://github.com/IUT-Blagnac/sae-3-01-devapp-2024-2025-g2b12/blob/master/GPO/CR_R%C3%A9union/Ordre%20du%20Jour%2026.11%20_%20Semaine%2048.pdf[ODJ Reunion_26.11.24]
...
Cette section regroupe toute la documentation du projet (de la conception, au développement jusqu'à l’utilisation de l’application). 
...
Récapitulatif des informations mises à jour :
