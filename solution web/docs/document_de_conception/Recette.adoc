...
^|C_G_C.1    ^|Remplir les champs dont on souhaite modifier les informations (Nom, Prénom, Email) et Enregistrer ^|Mise à jours des informations de l'utilisateur dans la base de données ^|Aucune ... ^| OK
